...
class StatusFragment extends StatefulWidget {
  ...
  StatusFragment({ this.globalScaffoldKey });

  @override
  _StatusFragmentState createState() => _StatusFragmentState();
}

class _StatusFragmentState extends State<StatusFragment> with AutomaticKeepAliveClientMixin<StatusFragment> {
